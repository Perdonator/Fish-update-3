...
function skinChange3() {
	if (Coins > 0 && Coins >= 5) {
		...
		document.getElementById("fishBtn").src = "ProFish.webp";
...
const sBB = [document.getElementsByTagName('button')[8], document.getElementsByTagName('button')[9], document.getElementsByTagName('button')[11]];
...
setInterval(() => {
	...
	localStorage.getItem('FishSkin3') === 'true' ? sBB[2].innerHTML = 'Equip skin' : sBB[1].innerHTML = 'Buy cool fish! (5 Coins)';
...
sBB[2].addEventListener('click', () => {

	localStorage.getItem('FishSkin3') === 'true' ? document.getElementById("fishBtn").src = "ProFish.webp" : skinChange3();
